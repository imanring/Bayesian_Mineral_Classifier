I created a Bayesian classifier of spectral images of Mars. 
...
This data is very difficult to deal classify, so I was only able to achieve 75% accuracy, and 54% class level accuracy.
